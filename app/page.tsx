...
export default function Home() {
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center justify-items-center sm:items-start bg-black/25 rounded-xl p-4">
        ...
        <div className="flex text-pretty justify-center max-w-screen-md">
          <p>
            ...
            microservices. I have a Master of Science in Game and Media
            Technology at Utrecht University. Enjoy most things tech and love 
            messing around with tech, learning and solving problems. Most passionate about
